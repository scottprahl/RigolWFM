...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.TektronixInternalIsf || (root.TektronixInternalIsf = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (TektronixInternalIsf_, KaitaiStream) {
/**
...
var TektronixInternalIsf = (function() {
  function TektronixInternalIsf(_io, _parent, _root) {
    this._io = _io;
  ...
  TektronixInternalIsf.prototype._read = function() {
    this.headerText = KaitaiStream.bytesToStr(this._io.readBytesTerm(35, false, true, true), "ASCII");
    this.nDigits = this._io.readU1();
    this.byteCountStr = KaitaiStream.bytesToStr(this._io.readBytes(this.nDigits - 48), "ASCII");
    this.curveData = this._io.readBytesFull();
  }
  ...
  return TektronixInternalIsf;
})();
TektronixInternalIsf_.TektronixInternalIsf = TektronixInternalIsf;
});
