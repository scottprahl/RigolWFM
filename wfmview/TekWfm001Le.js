...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.TekWfm001Le || (root.TekWfm001Le = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (TekWfm001Le_, KaitaiStream) {
/**
...
var TekWfm001Le = (function() {
  TekWfm001Le.BaseTypeEnum = Object.freeze({
    BASE_TIME: 0,
    BASE_SPECTRAL_MAG: 1,
  ...
  TekWfm001Le.ChecksumTypeEnum = Object.freeze({
    NO_CHECKSUM: 0,
    CTYPE_CRC16: 1,
    CTYPE_SUM16: 2,
    CTYPE_CRC32: 3,
  ...
  TekWfm001Le.DataTypeEnum = Object.freeze({
  ...
  TekWfm001Le.ExplicitFormatEnum = Object.freeze({
    EXPLICIT_INT16: 0,
    EXPLICIT_INT32: 1,
    EXPLICIT_UINT32: 2,
    EXPLICIT_UINT64: 3,
  ...
  TekWfm001Le.ExplicitStorageEnum = Object.freeze({
    EXPLICIT_SAMPLE: 0,
    EXPLICIT_MIN_MAX: 1,
  ...
  TekWfm001Le.PixMapFormatEnum = Object.freeze({
  ...
  TekWfm001Le.SetTypeEnum = Object.freeze({
    SINGLE_WAVEFORM: 0,
    FAST_FRAME: 1,
  ...
  TekWfm001Le.SweepEnum = Object.freeze({
    SWEEP_ROLL: 0,
    SWEEP_SAMPLE: 1,
    SWEEP_ET: 2,
    SWEEP_INVALID: 3,
  ...
  function TekWfm001Le(_io, _parent, _root) {
    this._io = _io;
  ...
  TekWfm001Le.prototype._read = function() {
  ...
  var ExpDim = TekWfm001Le.ExpDim = (function() {
  ...
  var ImpDim = TekWfm001Le.ImpDim = (function() {
  ...
  var StaticFileInfo = TekWfm001Le.StaticFileInfo = (function() {
  ...
  var TimeBaseInfo = TekWfm001Le.TimeBaseInfo = (function() {
  ...
  var WfmCurveObject = TekWfm001Le.WfmCurveObject = (function() {
  ...
  var WfmHeader = TekWfm001Le.WfmHeader = (function() {
  ...
  var WfmUpdateSpec = TekWfm001Le.WfmUpdateSpec = (function() {
   ...
   */
  Object.defineProperty(TekWfm001Le.prototype, 'curveBuffer', {
    get: function() {
...
TekWfm001Le_.TekWfm001Le = TekWfm001Le;
});
