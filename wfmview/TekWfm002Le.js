...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.TekWfm002Le || (root.TekWfm002Le = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (TekWfm002Le_, KaitaiStream) {
/**
...
var TekWfm002Le = (function() {
  TekWfm002Le.BaseTypeEnum = Object.freeze({
    BASE_TIME: 0,
    BASE_SPECTRAL_MAG: 1,
  ...
  TekWfm002Le.ChecksumTypeEnum = Object.freeze({
    NO_CHECKSUM: 0,
    CTYPE_CRC16: 1,
    CTYPE_SUM16: 2,
    CTYPE_CRC32: 3,
  ...
  TekWfm002Le.DataTypeEnum = Object.freeze({
  ...
  TekWfm002Le.ExplicitFormatEnum = Object.freeze({
    EXPLICIT_INT16: 0,
    EXPLICIT_INT32: 1,
    EXPLICIT_UINT32: 2,
    EXPLICIT_UINT64: 3,
  ...
  TekWfm002Le.ExplicitStorageEnum = Object.freeze({
    EXPLICIT_SAMPLE: 0,
    EXPLICIT_MIN_MAX: 1,
  ...
  TekWfm002Le.PixMapFormatEnum = Object.freeze({
  ...
  TekWfm002Le.SetTypeEnum = Object.freeze({
    SINGLE_WAVEFORM: 0,
    FAST_FRAME: 1,
  ...
  TekWfm002Le.SummaryFrameEnum = Object.freeze({
    SUMMARY_FRAME_OFF: 0,
  ...
  TekWfm002Le.SweepEnum = Object.freeze({
    SWEEP_ROLL: 0,
    SWEEP_SAMPLE: 1,
    SWEEP_ET: 2,
    SWEEP_INVALID: 3,
  ...
  function TekWfm002Le(_io, _parent, _root) {
    this._io = _io;
  ...
  TekWfm002Le.prototype._read = function() {
  ...
  var ExpDim = TekWfm002Le.ExpDim = (function() {
  ...
  var ImpDim = TekWfm002Le.ImpDim = (function() {
  ...
  var StaticFileInfo = TekWfm002Le.StaticFileInfo = (function() {
  ...
  var TimeBaseInfo = TekWfm002Le.TimeBaseInfo = (function() {
  ...
  var WfmCurveObject = TekWfm002Le.WfmCurveObject = (function() {
  ...
  var WfmHeader = TekWfm002Le.WfmHeader = (function() {
    ...
    WfmHeader.prototype._read = function() {
      ...
      this.summaryFrameType = this._io.readU2le();
    ...
    /**
     * Explicit dimension 1 (156 bytes; voltage axis for YT).  Offset 168.
     */

    /**
     * Explicit dimension 2 (156 bytes).  Offset 324.
     */

    /**
     * Implicit dimension 1 (132 bytes; time axis for YT).  Offset 480.
     */

    /**
     * Implicit dimension 2 (132 bytes).  Offset 612.
     */

    /**
     * Time-base 1 information (12 bytes).  Offset 744.
     */

    /**
     * Time-base 2 information (12 bytes).  Offset 756.
     */

    /**
     * Update specification for the first waveform frame (24 bytes).  Offset 768.
     */

    /**
     * Curve object for the first waveform frame (30 bytes).  Offset 792.
     */
  ...
  var WfmUpdateSpec = TekWfm002Le.WfmUpdateSpec = (function() {
   ...
   */
  Object.defineProperty(TekWfm002Le.prototype, 'curveBuffer', {
    get: function() {
...
TekWfm002Le_.TekWfm002Le = TekWfm002Le;
});
