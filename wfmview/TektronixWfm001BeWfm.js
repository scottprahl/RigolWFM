...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.TektronixWfm001BeWfm || (root.TektronixWfm001BeWfm = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (TektronixWfm001BeWfm_, KaitaiStream) {
/**
...
var TektronixWfm001BeWfm = (function() {
  TektronixWfm001BeWfm.BaseTypeEnum = Object.freeze({
    BASE_TIME: 0,
    BASE_SPECTRAL_MAG: 1,
  ...
  TektronixWfm001BeWfm.ChecksumTypeEnum = Object.freeze({
    NO_CHECKSUM: 0,
    CTYPE_CRC16: 1,
    CTYPE_SUM16: 2,
    CTYPE_CRC32: 3,
  ...
  TektronixWfm001BeWfm.DataTypeEnum = Object.freeze({
  ...
  TektronixWfm001BeWfm.ExplicitFormatEnum = Object.freeze({
    EXPLICIT_INT16: 0,
    EXPLICIT_INT32: 1,
    EXPLICIT_UINT32: 2,
    EXPLICIT_UINT64: 3,
  ...
  TektronixWfm001BeWfm.ExplicitStorageEnum = Object.freeze({
    EXPLICIT_SAMPLE: 0,
    EXPLICIT_MIN_MAX: 1,
  ...
  TektronixWfm001BeWfm.PixMapFormatEnum = Object.freeze({
  ...
  TektronixWfm001BeWfm.SetTypeEnum = Object.freeze({
    SINGLE_WAVEFORM: 0,
    FAST_FRAME: 1,
  ...
  TektronixWfm001BeWfm.SweepEnum = Object.freeze({
    SWEEP_ROLL: 0,
    SWEEP_SAMPLE: 1,
    SWEEP_ET: 2,
    SWEEP_INVALID: 3,
  ...
  function TektronixWfm001BeWfm(_io, _parent, _root) {
    this._io = _io;
  ...
  TektronixWfm001BeWfm.prototype._read = function() {
  ...
  var ExpDim = TektronixWfm001BeWfm.ExpDim = (function() {
  ...
  var ImpDim = TektronixWfm001BeWfm.ImpDim = (function() {
  ...
  var StaticFileInfo = TektronixWfm001BeWfm.StaticFileInfo = (function() {
  ...
  var TimeBaseInfo = TektronixWfm001BeWfm.TimeBaseInfo = (function() {
  ...
  var WfmCurveObject = TektronixWfm001BeWfm.WfmCurveObject = (function() {
  ...
  var WfmHeader = TektronixWfm001BeWfm.WfmHeader = (function() {
  ...
  var WfmUpdateSpec = TektronixWfm001BeWfm.WfmUpdateSpec = (function() {
   ...
   */
  Object.defineProperty(TektronixWfm001BeWfm.prototype, 'curveBuffer', {
    get: function() {
  ...
  return TektronixWfm001BeWfm;
})();
TektronixWfm001BeWfm_.TektronixWfm001BeWfm = TektronixWfm001BeWfm;
});
