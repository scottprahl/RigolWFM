...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.Lecroy10BeTrc || (root.Lecroy10BeTrc = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (Lecroy10BeTrc_, KaitaiStream) {
/**
...
var Lecroy10BeTrc = (function() {
  Lecroy10BeTrc.BandwidthLimitEnum = Object.freeze({
    BW_FULL: 0,
    BW_LIMITED: 1,
  ...
  Lecroy10BeTrc.CommOrderEnum = Object.freeze({
    BIG_ENDIAN: 0,
    LITTLE_ENDIAN: 1,
  ...
  Lecroy10BeTrc.CommTypeEnum = Object.freeze({
    BYTE: 0,
    WORD: 1,
  ...
  Lecroy10BeTrc.VertCouplingEnum = Object.freeze({
    DC_50_OHM: 0,
    GROUND: 1,
    DC_1M_OHM: 2,
    GROUND_B: 3,
  ...
  function Lecroy10BeTrc(_io, _parent, _root) {
    this._io = _io;
  ...
  Lecroy10BeTrc.prototype._read = function() {
  ...
  var TriggerTimestamp = Lecroy10BeTrc.TriggerTimestamp = (function() {
  ...
  var TrigtimeEntry = Lecroy10BeTrc.TrigtimeEntry = (function() {
  ...
  var Wavedesc = Lecroy10BeTrc.Wavedesc = (function() {
    ...
    Wavedesc.prototype._read = function() {
      ...
      this.recordType = this._io.readS2be();
      this.processingDone = this._io.readS2be();
      ...
      this.vertVernier = this._io.readF4be();
      this.acqVertOffset = this._io.readF4be();
      this.waveSourcePlugin = this._io.readS2be();
      this.waveSource = this._io.readS2be();
      this.triggerSource = this._io.readS2be();
      this.triggerCoupling = this._io.readS2be();
      this.triggerSlope = this._io.readS2be();
      this.smartTrigger = this._io.readS2be();
      this.triggerLevel = this._io.readF4be();
      this.sweepsArray1 = this._io.readS4be();
      this.sweepsArray2 = this._io.readS4be();
    ...
    Object.defineProperty(Wavedesc.prototype, 'is16bit', {
      get: function() {
        ...
        this._m_is16bit = this.commType == Lecroy10BeTrc.CommTypeEnum.WORD;
        return this._m_is16bit;
      }
    });
    ...
    /**
     * Byte order: 0 = HIFIRST (big-endian), 1 = LOFIRST (little-endian, use lecroy_1_0_le).  Offset 34.
     */
   ...
   */
  Object.defineProperty(Lecroy10BeTrc.prototype, 'trigtimeArray', {
    get: function() {
   ...
   */
  Object.defineProperty(Lecroy10BeTrc.prototype, 'userText', {
    get: function() {
   ...
   */
  Object.defineProperty(Lecroy10BeTrc.prototype, 'waveArray1', {
    get: function() {
   ...
   */
  Object.defineProperty(Lecroy10BeTrc.prototype, 'waveArray2', {
    get: function() {
  ...
  return Lecroy10BeTrc;
})();
Lecroy10BeTrc_.Lecroy10BeTrc = Lecroy10BeTrc;
});
