...
class RohdeSchwarzRtpWfm(KaitaiStruct):
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(RohdeSchwarzRtpWfm, self).__init__(_io)
        self._parent = _parent
        self._root = _root or self
        self._read()

    def _read(self):
        self.format_code = KaitaiStream.resolve_enum(RohdeSchwarzRtpWfm.FormatCodeEnum, self._io.read_u4le())
