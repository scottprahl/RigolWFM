...
class SiglentV02Bin(KaitaiStruct):
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(SiglentV02Bin, self).__init__(_io)
    ...
    class ScaledValue16(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentV02Bin.ScaledValue16, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    def ch1_vert_offset(self):
        ...
        _pos = self._io.pos()
        self._io.seek(196)
        self._m_ch1_vert_offset = SiglentV02Bin.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch1_volt_div(self):
        ...
        _pos = self._io.pos()
        self._io.seek(180)
        self._m_ch1_volt_div = SiglentV02Bin.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch2_vert_offset(self):
        ...
        _pos = self._io.pos()
        self._io.seek(360)
        self._m_ch2_vert_offset = SiglentV02Bin.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch2_volt_div(self):
        ...
        _pos = self._io.pos()
        self._io.seek(344)
        self._m_ch2_volt_div = SiglentV02Bin.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch3_vert_offset(self):
        ...
        _pos = self._io.pos()
        self._io.seek(524)
        self._m_ch3_vert_offset = SiglentV02Bin.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch3_volt_div(self):
        ...
        _pos = self._io.pos()
        self._io.seek(508)
        self._m_ch3_volt_div = SiglentV02Bin.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch4_vert_offset(self):
        ...
        _pos = self._io.pos()
        self._io.seek(688)
        self._m_ch4_vert_offset = SiglentV02Bin.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch4_volt_div(self):
        ...
        _pos = self._io.pos()
        self._io.seek(672)
        self._m_ch4_volt_div = SiglentV02Bin.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def sample_rate(self):
        ...
        _pos = self._io.pos()
        self._io.seek(3548)
        self._m_sample_rate = SiglentV02Bin.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def time_delay(self):
        ...
        _pos = self._io.pos()
        self._io.seek(3528)
        self._m_time_delay = SiglentV02Bin.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def time_div(self):
        ...
        _pos = self._io.pos()
        self._io.seek(3512)
        self._m_time_div = SiglentV02Bin.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
