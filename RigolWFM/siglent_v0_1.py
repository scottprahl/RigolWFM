...
class SiglentV01(KaitaiStruct):
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(SiglentV01, self).__init__(_io)
    ...
    class ScaledValue16(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentV01.ScaledValue16, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    def ch1_vert_offset(self):
        ...
        _pos = self._io.pos()
        self._io.seek(160)
        self._m_ch1_vert_offset = SiglentV01.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch1_volt_div(self):
        ...
        _pos = self._io.pos()
        self._io.seek(144)
        self._m_ch1_volt_div = SiglentV01.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch2_vert_offset(self):
        ...
        _pos = self._io.pos()
        self._io.seek(284)
        self._m_ch2_vert_offset = SiglentV01.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch2_volt_div(self):
        ...
        _pos = self._io.pos()
        self._io.seek(268)
        self._m_ch2_volt_div = SiglentV01.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch3_vert_offset(self):
        ...
        _pos = self._io.pos()
        self._io.seek(408)
        self._m_ch3_vert_offset = SiglentV01.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch3_volt_div(self):
        ...
        _pos = self._io.pos()
        self._io.seek(392)
        self._m_ch3_volt_div = SiglentV01.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch4_vert_offset(self):
        ...
        _pos = self._io.pos()
        self._io.seek(532)
        self._m_ch4_vert_offset = SiglentV01.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch4_volt_div(self):
        ...
        _pos = self._io.pos()
        self._io.seek(516)
        self._m_ch4_volt_div = SiglentV01.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def sample_rate(self):
        ...
        _pos = self._io.pos()
        self._io.seek(2728)
        self._m_sample_rate = SiglentV01.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def time_delay(self):
        ...
        _pos = self._io.pos()
        self._io.seek(2708)
        self._m_time_delay = SiglentV01.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def time_div(self):
        ...
        _pos = self._io.pos()
        self._io.seek(2692)
        self._m_time_div = SiglentV01.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
