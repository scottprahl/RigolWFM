...
class Lecroy10LeTrc(KaitaiStruct):
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(Lecroy10LeTrc, self).__init__(_io)
        self._parent = _parent
        self._root = _root or self
        self._read()

    def _read(self):
        self.wavedesc = Lecroy10LeTrc.Wavedesc(self._io, self, self._root)
    ...
    class TriggerTimestamp(KaitaiStruct):
        ...
        def __init__(self, _io, _parent=None, _root=None):
            super(Lecroy10LeTrc.TriggerTimestamp, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class TrigtimeEntry(KaitaiStruct):
        ...
        def __init__(self, _io, _parent=None, _root=None):
            super(Lecroy10LeTrc.TrigtimeEntry, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class Wavedesc(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(Lecroy10LeTrc.Wavedesc, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            self.comm_type = KaitaiStream.resolve_enum(Lecroy10LeTrc.CommTypeEnum, self._io.read_u2le())
            self.comm_order = KaitaiStream.resolve_enum(Lecroy10LeTrc.CommOrderEnum, self._io.read_u2le())
            ...
            self.trigger_time = Lecroy10LeTrc.TriggerTimestamp(self._io, self, self._root)
            ...
            self.vert_coupling = KaitaiStream.resolve_enum(Lecroy10LeTrc.VertCouplingEnum, self._io.read_u2le())
            self.probe_att = self._io.read_f4le()
            self.fixed_vert_gain = self._io.read_u2le()
            self.bandwidth_limit = KaitaiStream.resolve_enum(Lecroy10LeTrc.BandwidthLimitEnum, self._io.read_u2le())
        ...
        def is_16bit(self):
            ...
            self._m_is_16bit = self.comm_type == Lecroy10LeTrc.CommTypeEnum.word
    ...
    def trigtime_array(self):
        ...
        if self.wavedesc.trigtime_array_len > 0:
            ...
            for i in range(self.wavedesc.trigtime_array_len // 16):
                self._m_trigtime_array.append(Lecroy10LeTrc.TrigtimeEntry(self._io, self, self._root))
