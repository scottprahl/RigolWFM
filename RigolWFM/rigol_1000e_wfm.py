...
class Rigol1000eWfm(KaitaiStruct):
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(Rigol1000eWfm, self).__init__(_io)
    ...
    class ChannelHeader(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Rigol1000eWfm.ChannelHeader, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def unit(self):
            ...
            self._m_unit = Rigol1000eWfm.UnitEnum.v
    ...
    class Header(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Rigol1000eWfm.Header, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            self.ch = []
            for i in range(2):
                self.ch.append(Rigol1000eWfm.ChannelHeader(self._io, self, self._root))
            ...
            self.time = Rigol1000eWfm.TimeHeader(self._io, self, self._root)
            self.logic = Rigol1000eWfm.LogicAnalyzerHeader(self._io, self, self._root)
            self.trigger_mode = KaitaiStream.resolve_enum(Rigol1000eWfm.TriggerModeEnum, self._io.read_u1())
            self.trigger1 = Rigol1000eWfm.TriggerHeader(self._io, self, self._root)
            self.trigger2 = Rigol1000eWfm.TriggerHeader(self._io, self, self._root)
            ...
            self.time2 = Rigol1000eWfm.TimeHeader(self._io, self, self._root)
        ...
        def ch2_time_offset(self):
            ...
            self._m_ch2_time_offset = (1.0E-12 * self.time2.offset_measured if self.trigger_mode == Rigol1000eWfm.TriggerModeEnum.alt else self.ch1_time_offset)
        ...
        def ch2_time_scale(self):
            ...
            self._m_ch2_time_scale = (1.0E-12 * self.time2.scale_measured if self.trigger_mode == Rigol1000eWfm.TriggerModeEnum.alt else self.ch1_time_scale)
    ...
    class LogicAnalyzerHeader(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Rigol1000eWfm.LogicAnalyzerHeader, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class RawData(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Rigol1000eWfm.RawData, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class TimeHeader(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Rigol1000eWfm.TimeHeader, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class TriggerHeader(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Rigol1000eWfm.TriggerHeader, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()

        def _read(self):
            self.mode = KaitaiStream.resolve_enum(Rigol1000eWfm.TriggerModeEnum, self._io.read_u1())
            self.source = KaitaiStream.resolve_enum(Rigol1000eWfm.SourceEnum, self._io.read_u1())
    ...
    def data(self):
        ...
        _pos = self._io.pos()
        self._io.seek(276)
        self._m_data = Rigol1000eWfm.RawData(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def header(self):
        ...
        _pos = self._io.pos()
        self._io.seek(0)
        self._m_header = Rigol1000eWfm.Header(self._io, self, self._root)
        self._io.seek(_pos)
