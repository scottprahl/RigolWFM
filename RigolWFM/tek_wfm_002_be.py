...
class TekWfm002Be(KaitaiStruct):
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(TekWfm002Be, self).__init__(_io)
        self._parent = _parent
        self._root = _root or self
        self._read()

    def _read(self):
        self.static_file_info = TekWfm002Be.StaticFileInfo(self._io, self, self._root)
        self.wfm_header = TekWfm002Be.WfmHeader(self._io, self, self._root)
    ...
    class ExpDim(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(TekWfm002Be.ExpDim, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            self.format = KaitaiStream.resolve_enum(TekWfm002Be.ExplicitFormatEnum, self._io.read_s4be())
            self.storage_type = KaitaiStream.resolve_enum(TekWfm002Be.ExplicitStorageEnum, self._io.read_s4be())
    ...
    class ImpDim(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(TekWfm002Be.ImpDim, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class StaticFileInfo(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(TekWfm002Be.StaticFileInfo, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class TimeBaseInfo(KaitaiStruct):
        ...
        def __init__(self, _io, _parent=None, _root=None):
            super(TekWfm002Be.TimeBaseInfo, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            self.sweep = KaitaiStream.resolve_enum(TekWfm002Be.SweepEnum, self._io.read_s4be())
            self.type_of_base = KaitaiStream.resolve_enum(TekWfm002Be.BaseTypeEnum, self._io.read_s4be())
    ...
    class WfmCurveObject(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(TekWfm002Be.WfmCurveObject, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            self.checksum_type = KaitaiStream.resolve_enum(TekWfm002Be.ChecksumTypeEnum, self._io.read_s4be())
    ...
    class WfmHeader(KaitaiStruct):
        ...
        def _read(self):
            self.set_type = KaitaiStream.resolve_enum(TekWfm002Be.SetTypeEnum, self._io.read_s4be())
            ...
            self.data_type = KaitaiStream.resolve_enum(TekWfm002Be.DataTypeEnum, self._io.read_s4be())
            ...
            self.summary_frame_type = KaitaiStream.resolve_enum(TekWfm002Be.SummaryFrameEnum, self._io.read_u2be())
            self.pix_map_display_format = KaitaiStream.resolve_enum(TekWfm002Be.PixMapFormatEnum, self._io.read_s4be())
            self.pix_map_max_value = self._io.read_u8be()
            self.exp_dim1 = TekWfm002Be.ExpDim(self._io, self, self._root)
            self.exp_dim2 = TekWfm002Be.ExpDim(self._io, self, self._root)
            self.imp_dim1 = TekWfm002Be.ImpDim(self._io, self, self._root)
            self.imp_dim2 = TekWfm002Be.ImpDim(self._io, self, self._root)
            self.time_base1 = TekWfm002Be.TimeBaseInfo(self._io, self, self._root)
            self.time_base2 = TekWfm002Be.TimeBaseInfo(self._io, self, self._root)
            self.update_spec = TekWfm002Be.WfmUpdateSpec(self._io, self, self._root)
            self.curve = TekWfm002Be.WfmCurveObject(self._io, self, self._root)
    ...
    class WfmUpdateSpec(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(TekWfm002Be.WfmUpdateSpec, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
