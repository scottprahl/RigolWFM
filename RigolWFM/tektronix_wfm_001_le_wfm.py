...
class TektronixWfm001LeWfm(KaitaiStruct):
    ...
    Sources used for this KSY binary format: "Reference Waveform File Format"
    (001-1378-03).
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(TektronixWfm001LeWfm, self).__init__(_io)
        self._parent = _parent
        self._root = _root or self
        self._read()

    def _read(self):
        self.static_file_info = TektronixWfm001LeWfm.StaticFileInfo(self._io, self, self._root)
        self.wfm_header = TektronixWfm001LeWfm.WfmHeader(self._io, self, self._root)
    ...
    class ExpDim(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(TektronixWfm001LeWfm.ExpDim, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            self.format = KaitaiStream.resolve_enum(TektronixWfm001LeWfm.ExplicitFormatEnum, self._io.read_s4le())
            self.storage_type = KaitaiStream.resolve_enum(TektronixWfm001LeWfm.ExplicitStorageEnum, self._io.read_s4le())
    ...
    class ImpDim(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(TektronixWfm001LeWfm.ImpDim, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class StaticFileInfo(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(TektronixWfm001LeWfm.StaticFileInfo, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            self.version_number = self._io.read_bytes(7)
    ...
    class TimeBaseInfo(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(TektronixWfm001LeWfm.TimeBaseInfo, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            self.sweep = KaitaiStream.resolve_enum(TektronixWfm001LeWfm.SweepEnum, self._io.read_s4le())
            self.type_of_base = KaitaiStream.resolve_enum(TektronixWfm001LeWfm.BaseTypeEnum, self._io.read_s4le())
    ...
    class WfmCurveObject(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(TektronixWfm001LeWfm.WfmCurveObject, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            self.checksum_type = KaitaiStream.resolve_enum(TektronixWfm001LeWfm.ChecksumTypeEnum, self._io.read_s4le())
    ...
    class WfmHeader(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(TektronixWfm001LeWfm.WfmHeader, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()

        def _read(self):
            self.set_type = KaitaiStream.resolve_enum(TektronixWfm001LeWfm.SetTypeEnum, self._io.read_s4le())
            ...
            self.data_type = KaitaiStream.resolve_enum(TektronixWfm001LeWfm.DataTypeEnum, self._io.read_s4le())
            ...
            self.pix_map_display_format = KaitaiStream.resolve_enum(TektronixWfm001LeWfm.PixMapFormatEnum, self._io.read_s4le())
            self.pix_map_max_value = self._io.read_u8le()
            self.exp_dim1 = TektronixWfm001LeWfm.ExpDim(self._io, self, self._root)
            self.exp_dim2 = TektronixWfm001LeWfm.ExpDim(self._io, self, self._root)
            self.imp_dim1 = TektronixWfm001LeWfm.ImpDim(self._io, self, self._root)
            self.imp_dim2 = TektronixWfm001LeWfm.ImpDim(self._io, self, self._root)
            self.time_base1 = TektronixWfm001LeWfm.TimeBaseInfo(self._io, self, self._root)
            self.time_base2 = TektronixWfm001LeWfm.TimeBaseInfo(self._io, self, self._root)
            self.update_spec = TektronixWfm001LeWfm.WfmUpdateSpec(self._io, self, self._root)
            self.curve = TektronixWfm001LeWfm.WfmCurveObject(self._io, self, self._root)
    ...
    class WfmUpdateSpec(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(TektronixWfm001LeWfm.WfmUpdateSpec, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
