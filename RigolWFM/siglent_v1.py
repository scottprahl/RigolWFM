...
class SiglentV1(KaitaiStruct):
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(SiglentV1, self).__init__(_io)
    ...
    class S4Array4(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentV1.S4Array4, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class ScaledValue16(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentV1.ScaledValue16, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class ScaledValue16Array4(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentV1.ScaledValue16Array4, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            self.entries = []
            for i in range(4):
                self.entries.append(SiglentV1.ScaledValue16(self._io, self, self._root))
    ...
    class U4Array16(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentV1.U4Array16, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    def ch_on(self):
        ...
        _pos = self._io.pos()
        self._io.seek(0)
        self._m_ch_on = SiglentV1.S4Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch_vert_offset(self):
        ...
        _pos = self._io.pos()
        self._io.seek(80)
        self._m_ch_vert_offset = SiglentV1.ScaledValue16Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch_volt_div(self):
        ...
        _pos = self._io.pos()
        self._io.seek(16)
        self._m_ch_volt_div = SiglentV1.ScaledValue16Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def digital_ch_on(self):
        ...
        _pos = self._io.pos()
        self._io.seek(148)
        self._m_digital_ch_on = SiglentV1.U4Array16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def digital_sample_rate(self):
        ...
        _pos = self._io.pos()
        self._io.seek(268)
        self._m_digital_sample_rate = SiglentV1.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def sample_rate(self):
        ...
        _pos = self._io.pos()
        self._io.seek(248)
        self._m_sample_rate = SiglentV1.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def time_delay(self):
        ...
        _pos = self._io.pos()
        self._io.seek(228)
        self._m_time_delay = SiglentV1.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def time_div(self):
        ...
        _pos = self._io.pos()
        self._io.seek(212)
        self._m_time_div = SiglentV1.ScaledValue16(self._io, self, self._root)
        self._io.seek(_pos)
