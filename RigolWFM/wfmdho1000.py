...
class Wfmdho1000(KaitaiStruct):
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(Wfmdho1000, self).__init__(_io)
        self._parent = _parent
        self._root = _root or self
        self._read()

    def _read(self):
        self.file_header = Wfmdho1000.FileHeader(self._io, self, self._root)
        self.blocks = []
        i = 0
        while True:
    ...
    class Block(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(Wfmdho1000.Block, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def is_channel_params(self):
            ...
            self._m_is_channel_params =  ((self.block_type == Wfmdho1000.BlockTypeEnum.channel_params) and (self.block_id >= 1) and (self.block_id <= 4)) 
        ...
        def is_settings(self):
            ...
            self._m_is_settings = self.block_type == Wfmdho1000.BlockTypeEnum.settings
    ...
    class Dho1000ChannelParams(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(Wfmdho1000.Dho1000ChannelParams, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class Dho800ChannelParams(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(Wfmdho1000.Dho800ChannelParams, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class FileHeader(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(Wfmdho1000.FileHeader, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class SettingsBlock(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(Wfmdho1000.SettingsBlock, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
