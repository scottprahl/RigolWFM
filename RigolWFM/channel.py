...
class Channel:
    ...
    def __init__(self, w: Any, channel_number: int, scope: str, selected: str = "1234") -> None:
        ...
        elif scope == "siglent_bin":
            self.siglent(w, channel_number)
        elif scope == "rohde_schwarz_bin":
            self.rohde_schwarz(w, channel_number)
        elif scope == "tek_wfm":
    ...
    def siglent(self, w: Any, channel_number: int) -> None:
    ...
    def rohde_schwarz(self, w: Any, channel_number: int) -> None:
