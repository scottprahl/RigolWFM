...
class Wfm1000z(KaitaiStruct):
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(Wfm1000z, self).__init__(_io)
    ...
    class ChannelHead(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Wfm1000z.ChannelHead, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class ChannelSubhead(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Wfm1000z.ChannelSubhead, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class FileHeader(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Wfm1000z.FileHeader, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class RawData(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Wfm1000z.RawData, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class WfmHeader(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Wfm1000z.WfmHeader, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
