...
class SiglentV3(KaitaiStruct):
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(SiglentV3, self).__init__(_io)
    ...
    class DataWithUnit(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentV3.DataWithUnit, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class DataWithUnitArray4(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentV3.DataWithUnitArray4, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            self.entries = []
            for i in range(4):
                self.entries.append(SiglentV3.DataWithUnit(self._io, self, self._root))
    ...
    class F8Array4(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentV3.F8Array4, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class S4Array4(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentV3.S4Array4, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class U4Array16(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentV3.U4Array16, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class U4Array4(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentV3.U4Array4, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    def ch_on(self):
        ...
        _pos = self._io.pos()
        self._io.seek(4)
        self._m_ch_on = SiglentV3.S4Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch_probe(self):
        ...
        _pos = self._io.pos()
        self._io.seek(576)
        self._m_ch_probe = SiglentV3.F8Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch_vert_code_per_div(self):
        ...
        _pos = self._io.pos()
        self._io.seek(620)
        self._m_ch_vert_code_per_div = SiglentV3.S4Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch_vert_offset(self):
        ...
        _pos = self._io.pos()
        self._io.seek(180)
        self._m_ch_vert_offset = SiglentV3.DataWithUnitArray4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch_volt_div(self):
        ...
        _pos = self._io.pos()
        self._io.seek(20)
        self._m_ch_volt_div = SiglentV3.DataWithUnitArray4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def digital_ch_on(self):
        ...
        _pos = self._io.pos()
        self._io.seek(344)
        self._m_digital_ch_on = SiglentV3.U4Array16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def digital_sample_rate(self):
        ...
        _pos = self._io.pos()
        self._io.seek(536)
        self._m_digital_sample_rate = SiglentV3.DataWithUnit(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def math_f_time(self):
        ...
        _pos = self._io.pos()
        self._io.seek(988)
        self._m_math_f_time = SiglentV3.F8Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def math_store_len(self):
        ...
        _pos = self._io.pos()
        self._io.seek(972)
        self._m_math_store_len = SiglentV3.U4Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def math_switch(self):
        ...
        _pos = self._io.pos()
        self._io.seek(636)
        self._m_math_switch = SiglentV3.S4Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def sample_rate(self):
        ...
        _pos = self._io.pos()
        self._io.seek(492)
        self._m_sample_rate = SiglentV3.DataWithUnit(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def time_delay(self):
        ...
        _pos = self._io.pos()
        self._io.seek(448)
        self._m_time_delay = SiglentV3.DataWithUnit(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def time_div(self):
        ...
        _pos = self._io.pos()
        self._io.seek(408)
        self._m_time_div = SiglentV3.DataWithUnit(self._io, self, self._root)
        self._io.seek(_pos)
