...
class Wfm4000(KaitaiStruct):
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(Wfm4000, self).__init__(_io)
    ...
    class ChannelHeader(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Wfm4000.ChannelHeader, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class ChannelMask(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Wfm4000.ChannelMask, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class Header(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Wfm4000.Header, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class PositionType(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Wfm4000.PositionType, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
