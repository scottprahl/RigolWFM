...
class Lecroy23BeTrc(KaitaiStruct):
    ...
    adapter logic, and comparison against the repo's real `LECROY_2_3` fixtures.
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(Lecroy23BeTrc, self).__init__(_io)
        self._parent = _parent
        self._root = _root or self
        self._read()

    def _read(self):
        self.wavedesc = Lecroy23BeTrc.Wavedesc(self._io, self, self._root)
    ...
    class TriggerTimestamp(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(Lecroy23BeTrc.TriggerTimestamp, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class TrigtimeEntry(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(Lecroy23BeTrc.TrigtimeEntry, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class Wavedesc(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(Lecroy23BeTrc.Wavedesc, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            self.comm_type = KaitaiStream.resolve_enum(Lecroy23BeTrc.CommTypeEnum, self._io.read_u2be())
            self.comm_order = KaitaiStream.resolve_enum(Lecroy23BeTrc.CommOrderEnum, self._io.read_u2be())
            self.wave_descriptor = self._io.read_s4be()
            self.user_text_len = self._io.read_s4be()
            self.res_desc1 = self._io.read_s4be()
            self.trigtime_array_len = self._io.read_s4be()
            self.ris_time_array_len = self._io.read_s4be()
            self.res_array1 = self._io.read_s4be()
            self.wave_array_1_len = self._io.read_s4be()
            self.wave_array_2_len = self._io.read_s4be()
            self.res_array2 = self._io.read_s4be()
            self.res_array3 = self._io.read_s4be()
            ...
            self.reserved1 = self._io.read_s2be()
            self.reserved2 = self._io.read_s2be()
            self.wave_array_count = self._io.read_s4be()
            self.pnts_per_screen = self._io.read_s4be()
            self.first_valid_pnt = self._io.read_s4be()
            self.last_valid_pnt = self._io.read_s4be()
            self.first_point = self._io.read_s4be()
            self.sparsing_factor = self._io.read_s4be()
            self.segment_index = self._io.read_s4be()
            self.subarray_count = self._io.read_s4be()
            self.sweeps_per_acq = self._io.read_s4be()
            self.points_per_pair = self._io.read_s2be()
            self.pair_offset = self._io.read_s2be()
            self.vertical_gain = self._io.read_f4be()
            self.vertical_offset = self._io.read_f4be()
            self.max_value = self._io.read_f4be()
            self.min_value = self._io.read_f4be()
            self.nominal_bits = self._io.read_s2be()
            self.nom_subarray_count = self._io.read_s2be()
            ...
            self.horiz_uncertainty = self._io.read_f4be()
            self.trigger_time = Lecroy23BeTrc.TriggerTimestamp(self._io, self, self._root)
            self.acq_duration = self._io.read_f4be()
            self.record_type = KaitaiStream.resolve_enum(Lecroy23BeTrc.RecordTypeEnum, self._io.read_u2be())
            self.processing_done = KaitaiStream.resolve_enum(Lecroy23BeTrc.ProcessingDoneEnum, self._io.read_u2be())
            self.reserved5 = self._io.read_s2be()
            self.ris_sweeps = self._io.read_s2be()
            self.timebase = self._io.read_u2be()
            self.vert_coupling = KaitaiStream.resolve_enum(Lecroy23BeTrc.VertCouplingEnum, self._io.read_u2be())
            self.probe_att = self._io.read_f4be()
            self.fixed_vert_gain = self._io.read_u2be()
            self.bandwidth_limit = KaitaiStream.resolve_enum(Lecroy23BeTrc.BandwidthLimitEnum, self._io.read_u2be())
            self.vertical_vernier = self._io.read_f4be()
            self.acq_vert_offset = self._io.read_f4be()
            self.wave_source = KaitaiStream.resolve_enum(Lecroy23BeTrc.WaveSourceEnum, self._io.read_u2be())
        ...
        def is_16bit(self):
            ...
            self._m_is_16bit = self.comm_type == Lecroy23BeTrc.CommTypeEnum.word
    ...
    def trigtime_array(self):
        ...
        if self.wavedesc.trigtime_array_len > 0:
            ...
            for i in range(self.wavedesc.trigtime_array_len // 16):
                self._m_trigtime_array.append(Lecroy23BeTrc.TrigtimeEntry(self._io, self, self._root))
