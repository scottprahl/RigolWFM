...
class SiglentOldPlatform(KaitaiStruct):
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(SiglentOldPlatform, self).__init__(_io)
    ...
    class F4Array4(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentOldPlatform.F4Array4, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class S4Array4(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentOldPlatform.S4Array4, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class U1Array16(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentOldPlatform.U1Array16, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    def ch_on(self):
        ...
        _pos = self._io.pos()
        self._io.seek(256)
        self._m_ch_on = SiglentOldPlatform.S4Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch_vert_offset_pixels(self):
        ...
        _pos = self._io.pos()
        self._io.seek(220)
        self._m_ch_vert_offset_pixels = SiglentOldPlatform.S4Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch_volt_div_mv(self):
        ...
        _pos = self._io.pos()
        self._io.seek(188)
        self._m_ch_volt_div_mv = SiglentOldPlatform.F4Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def mso_ch_open_stats(self):
        ...
        _pos = self._io.pos()
        self._io.seek(20)
        self._m_mso_ch_open_stats = SiglentOldPlatform.U1Array16(self._io, self, self._root)
        self._io.seek(_pos)
