...
class Rigol1000bWfm(KaitaiStruct):
    ...
    and other DS1000B-series scopes that share this layout.
    """
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(Rigol1000bWfm, self).__init__(_io)
    ...
    class ChannelHeader(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Rigol1000bWfm.ChannelHeader, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def unit(self):
            ...
            self._m_unit = Rigol1000bWfm.UnitEnum.v
    ...
    class Header(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Rigol1000bWfm.Header, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            self.ch = []
            for i in range(4):
                self.ch.append(Rigol1000bWfm.ChannelHeader(self._io, self, self._root))
            ...
            self.trigger_mode = KaitaiStream.resolve_enum(Rigol1000bWfm.TriggerModeEnum, self._io.read_u1())
            self.unknown_6 = self._io.read_u1()
            self.trigger_source = KaitaiStream.resolve_enum(Rigol1000bWfm.TriggerSourceEnum, self._io.read_u1())
    ...
    def header(self):
        ...
        _pos = self._io.pos()
        self._io.seek(0)
        self._m_header = Rigol1000bWfm.Header(self._io, self, self._root)
        self._io.seek(_pos)
