...
class Rigol1000cWfm(KaitaiStruct):
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(Rigol1000cWfm, self).__init__(_io)
    ...
    class ChannelHeader(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Rigol1000cWfm.ChannelHeader, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def unit(self):
            ...
            self._m_unit = Rigol1000cWfm.UnitEnum.v
    ...
    class Header(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Rigol1000cWfm.Header, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            self.ch = []
            for i in range(2):
                self.ch.append(Rigol1000cWfm.ChannelHeader(self._io, self, self._root))
            ...
            self.trigger_mode = KaitaiStream.resolve_enum(Rigol1000cWfm.TriggerModeEnum, self._io.read_u1())
            self.unknown_6 = self._io.read_u1()
            self.trigger_source = KaitaiStream.resolve_enum(Rigol1000cWfm.TriggerSourceEnum, self._io.read_u1())
    ...
    class RawData(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Rigol1000cWfm.RawData, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    def data(self):
        ...
        _pos = self._io.pos()
        self._io.seek(256)
        self._m_data = Rigol1000cWfm.RawData(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def header(self):
        ...
        _pos = self._io.pos()
        self._io.seek(0)
        self._m_header = Rigol1000cWfm.Header(self._io, self, self._root)
        self._io.seek(_pos)
