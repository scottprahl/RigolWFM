...
class SiglentV4(KaitaiStruct):
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(SiglentV4, self).__init__(_io)
    ...
    class DataWithUnit(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentV4.DataWithUnit, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class DataWithUnitArray4(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentV4.DataWithUnitArray4, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            self.entries = []
            for i in range(4):
                self.entries.append(SiglentV4.DataWithUnit(self._io, self, self._root))
    ...
    class F8Array4(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentV4.F8Array4, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class S4Array4(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentV4.S4Array4, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class U4Array16(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentV4.U4Array16, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class U4Array4(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(SiglentV4.U4Array4, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    def ch_on_1_4(self):
        ...
        _pos = self._io.pos()
        self._io.seek(8)
        self._m_ch_on_1_4 = SiglentV4.S4Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch_on_5_8(self):
        ...
        _pos = self._io.pos()
        self._io.seek(1028)
        self._m_ch_on_5_8 = SiglentV4.S4Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch_probe_1_4(self):
        ...
        _pos = self._io.pos()
        self._io.seek(580)
        self._m_ch_probe_1_4 = SiglentV4.F8Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch_probe_5_8(self):
        ...
        _pos = self._io.pos()
        self._io.seek(1364)
        self._m_ch_probe_5_8 = SiglentV4.F8Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch_vert_code_per_div_1_4(self):
        ...
        _pos = self._io.pos()
        self._io.seek(624)
        self._m_ch_vert_code_per_div_1_4 = SiglentV4.S4Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch_vert_code_per_div_5_8(self):
        ...
        _pos = self._io.pos()
        self._io.seek(1396)
        self._m_ch_vert_code_per_div_5_8 = SiglentV4.S4Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch_vert_offset_1_4(self):
        ...
        _pos = self._io.pos()
        self._io.seek(184)
        self._m_ch_vert_offset_1_4 = SiglentV4.DataWithUnitArray4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch_vert_offset_5_8(self):
        ...
        _pos = self._io.pos()
        self._io.seek(1204)
        self._m_ch_vert_offset_5_8 = SiglentV4.DataWithUnitArray4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch_volt_div_1_4(self):
        ...
        _pos = self._io.pos()
        self._io.seek(24)
        self._m_ch_volt_div_1_4 = SiglentV4.DataWithUnitArray4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def ch_volt_div_5_8(self):
        ...
        _pos = self._io.pos()
        self._io.seek(1044)
        self._m_ch_volt_div_5_8 = SiglentV4.DataWithUnitArray4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def digital_ch_on(self):
        ...
        _pos = self._io.pos()
        self._io.seek(348)
        self._m_digital_ch_on = SiglentV4.U4Array16(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def digital_sample_rate(self):
        ...
        _pos = self._io.pos()
        self._io.seek(540)
        self._m_digital_sample_rate = SiglentV4.DataWithUnit(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def math_f_time(self):
        ...
        _pos = self._io.pos()
        self._io.seek(992)
        self._m_math_f_time = SiglentV4.F8Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def math_store_len(self):
        ...
        _pos = self._io.pos()
        self._io.seek(976)
        self._m_math_store_len = SiglentV4.U4Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def math_switch(self):
        ...
        _pos = self._io.pos()
        self._io.seek(640)
        self._m_math_switch = SiglentV4.S4Array4(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def sample_rate(self):
        ...
        _pos = self._io.pos()
        self._io.seek(496)
        self._m_sample_rate = SiglentV4.DataWithUnit(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def time_delay(self):
        ...
        _pos = self._io.pos()
        self._io.seek(452)
        self._m_time_delay = SiglentV4.DataWithUnit(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def time_div(self):
        ...
        _pos = self._io.pos()
        self._io.seek(412)
        self._m_time_div = SiglentV4.DataWithUnit(self._io, self, self._root)
        self._io.seek(_pos)
