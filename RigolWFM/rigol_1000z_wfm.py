...
class Rigol1000zWfm(KaitaiStruct):
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(Rigol1000zWfm, self).__init__(_io)
    ...
    def _fetch_instances(self):
        ...
        if hasattr(self, '_m_preheader'):
            pass
            self._m_preheader._fetch_instances()


    class ChannelHead(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Rigol1000zWfm.ChannelHead, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            self.coupling = KaitaiStream.resolve_enum(Rigol1000zWfm.CouplingEnum, self._io.read_u1())
            self.bandwidth_limit = KaitaiStream.resolve_enum(Rigol1000zWfm.BandwidthEnum, self._io.read_u1())
            self.probe_type = self._io.read_u1()
            self.probe_ratio = KaitaiStream.resolve_enum(Rigol1000zWfm.ProbeEnum, self._io.read_u1())
            ...
            self.unit = KaitaiStream.resolve_enum(Rigol1000zWfm.UnitEnum, self._io.read_u1())
        ...
        def probe_value(self):
            ...
            self._m_probe_value = (0.01 if self.probe_ratio == Rigol1000zWfm.ProbeEnum.x0_01 else (0.02 if self.probe_ratio == Rigol1000zWfm.ProbeEnum.x0_02 else (0.05 if self.probe_ratio == Rigol1000zWfm.ProbeEnum.x0_05 else (0.1 if self.probe_ratio == Rigol1000zWfm.ProbeEnum.x0_1 else (0.2 if self.probe_ratio == Rigol1000zWfm.ProbeEnum.x0_2 else (0.5 if self.probe_ratio == Rigol1000zWfm.ProbeEnum.x0_5 else (1.0 if self.probe_ratio == Rigol1000zWfm.ProbeEnum.x1 else (2.0 if self.probe_ratio == Rigol1000zWfm.ProbeEnum.x2 else (5.0 if self.probe_ratio == Rigol1000zWfm.ProbeEnum.x5 else (10.0 if self.probe_ratio == Rigol1000zWfm.ProbeEnum.x10 else (20.0 if self.probe_ratio == Rigol1000zWfm.ProbeEnum.x20 else (50.0 if self.probe_ratio == Rigol1000zWfm.ProbeEnum.x50 else (100.0 if self.probe_ratio == Rigol1000zWfm.ProbeEnum.x100 else (200.0 if self.probe_ratio == Rigol1000zWfm.ProbeEnum.x200 else (500.0 if self.probe_ratio == Rigol1000zWfm.ProbeEnum.x500 else 1000.0)))))))))))))))
    ...
    class ChannelSubhead(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Rigol1000zWfm.ChannelSubhead, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class FileHeader(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Rigol1000zWfm.FileHeader, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class HorizontalBlock(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(Rigol1000zWfm.HorizontalBlock, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def normalized_a(self):
            ...
            _pos = self._io.pos()
            self._io.seek(0)
            self._m_normalized_a = Rigol1000zWfm.NormalizedChannelTable(self._io, self, self._root)
            self._io.seek(_pos)
        ...
        def normalized_b(self):
            ...
            _pos = self._io.pos()
            self._io.seek(448)
            self._m_normalized_b = Rigol1000zWfm.NormalizedChannelTable(self._io, self, self._root)
            self._io.seek(_pos)
    ...
    class NormalizedChannelTable(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Rigol1000zWfm.NormalizedChannelTable, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class RawData(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Rigol1000zWfm.RawData, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class WfmHeader(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Rigol1000zWfm.WfmHeader, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            self.acq_mode = KaitaiStream.resolve_enum(Rigol1000zWfm.AcquistionEnum, self._io.read_u1())
            ...
            self.time_mode = KaitaiStream.resolve_enum(Rigol1000zWfm.TimeModeEnum, self._io.read_u1())
            self.memory_depth = self._io.read_u4le()
            self.sample_rate_ghz = self._io.read_f4le()
            self.ch = []
            for i in range(4):
                self.ch.append(Rigol1000zWfm.ChannelHead(self._io, self, self._root))
    ...
    def data(self):
        ...
        self._m_data = Rigol1000zWfm.RawData(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def header(self):
        ...
        _pos = self._io.pos()
        self._io.seek(64)
        self._m_header = Rigol1000zWfm.WfmHeader(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def horizontal(self):
        ...
        self._m_horizontal = Rigol1000zWfm.HorizontalBlock(_io__raw__m_horizontal, self, self._root)
        self._io.seek(_pos)
    ...
    def preheader(self):
        ...
        _pos = self._io.pos()
        self._io.seek(0)
        self._m_preheader = Rigol1000zWfm.FileHeader(self._io, self, self._root)
        self._io.seek(_pos)
