...
class RigolMso5000Bin(KaitaiStruct):
    ...
    def __init__(self, _io, _parent=None, _root=None):
        super(RigolMso5000Bin, self).__init__(_io)
        self._parent = _parent
        self._root = _root or self
        self._read()

    def _read(self):
        self.file_header = RigolMso5000Bin.FileHeader(self._io, self, self._root)
        self.waveforms = []
        for i in range(self.file_header.n_waveforms):
            self.waveforms.append(RigolMso5000Bin.Waveform(self._io, self, self._root))
    ...
    class DataHeader(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(RigolMso5000Bin.DataHeader, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            self.buffer_type = KaitaiStream.resolve_enum(RigolMso5000Bin.BufferTypeEnum, self._io.read_u2le())
    ...
    class FileHeader(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(RigolMso5000Bin.FileHeader, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class Waveform(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(RigolMso5000Bin.Waveform, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()

        def _read(self):
            self.wfm_header = RigolMso5000Bin.WaveformHeader(self._io, self, self._root)
            self.data_header = RigolMso5000Bin.DataHeader(self._io, self, self._root)
    ...
    class WaveformHeader(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(RigolMso5000Bin.WaveformHeader, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            self.header_size = self._io.read_u4le()
            self.waveform_type = KaitaiStream.resolve_enum(RigolMso5000Bin.WaveformTypeEnum, self._io.read_u4le())
            ...
            self.x_units = KaitaiStream.resolve_enum(RigolMso5000Bin.UnitEnum, self._io.read_u4le())
            self.y_units = KaitaiStream.resolve_enum(RigolMso5000Bin.UnitEnum, self._io.read_u4le())
