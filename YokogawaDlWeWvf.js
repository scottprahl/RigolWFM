...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.YokogawaDlWeWvf || (root.YokogawaDlWeWvf = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (YokogawaDlWeWvf_, KaitaiStream) {
/**
...
var YokogawaDlWeWvf = (function() {
  function YokogawaDlWeWvf(_io, _parent, _root, lenLeadingUnused) {
    this._io = _io;
    this._parent = _parent;
    this._root = _root || this;
    this.lenLeadingUnused = lenLeadingUnused;

    this._read();
  }
  YokogawaDlWeWvf.prototype._read = function() {
    this.leadingUnused = this._io.readBytes(this.lenLeadingUnused);
   ...
   *   - Byte order (Endian field: "Big" = BE, "Ltl" = LE)
  ...
  return YokogawaDlWeWvf;
})();
YokogawaDlWeWvf_.YokogawaDlWeWvf = YokogawaDlWeWvf;
});
